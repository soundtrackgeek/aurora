...
Aurora is a fast, local-first Windows 11 explorer and player for a personal music universe. Version 0.15.12 streamlines the Songs, Albums, and Artists filter bar around search-first browsing.

![Aurora design reference](Aurora.png)

## Current 0.15.12 slice
