...
Aurora is a fast, local-first Windows 11 explorer and player for a personal music universe. Version 0.17.12 keeps the selected or playing track's Artist and Publisher metadata intact across every library and playback route.

![Aurora design reference](Aurora.png)

## Current 0.17.12 slice
