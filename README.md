...
Aurora is a fast, local-first Windows 11 explorer and player for a personal music universe. Version 0.18.0 adds Inbox staging, monitored folders, MusicBrainz/Discogs auto-tagging, and reviewed promotion into the library.

![Aurora design reference](Aurora.png)

## Current 0.18.0 slice
