...
Aurora is a fast, local-first Windows 11 explorer and player for a personal music universe. Version 0.15.11 shows the exact number of matching songs, albums, or artists beside catalog search.

![Aurora design reference](Aurora.png)

## Current 0.15.11 slice
