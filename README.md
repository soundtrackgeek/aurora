...
Aurora is a fast, local-first Windows 11 explorer and player for a personal music universe. Version 0.24.38 fixes saving artwork from Tags when an album has no existing cover. New covers are embedded and verified in the MP3s; existing archive replacements retain their rollback safeguards. Albums without an archive entry may need Music Library cover import before the album card displays the new artwork.

![Aurora design reference](Aurora.png)

## Current 0.24.38 slice
